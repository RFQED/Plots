...
//=========  (Wed Mar 16 08:12:35 2016) by ROOT version5.34/25
   TCanvas *Canvas_1 = new TCanvas("Canvas_1", "Canvas_1",262,226,538,323);
   Canvas_1->Range(-0.625,-3505.952,5.625,32390.07);
   ...
   LayersHit->SetBinContent(1,27433);
   LayersHit->SetBinContent(2,1386);
   LayersHit->SetBinContent(3,4125);
   LayersHit->SetBinContent(4,13445);
   LayersHit->SetBinContent(5,14411);
   LayersHit->SetEntries(38000);
